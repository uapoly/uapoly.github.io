 ...
 * @package     Evita
 * @author      Evita
 * @copyright   Copyright (c) 2022, Evita
 * @since       1.0
 */
...
class Evita_Icon_Picker_Control extends WP_Customize_Control
{
  ...
  public function __construct( $manager, $id, $args = array(), $options = array() ) {
    $this->icons = $this->Evita_get_icons();
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'evita-icon-picker-css', EVITA_PARENT_URI . '/assets/fonticonpicker/jquery.fonticonpicker.min.css', false );
			 
		wp_enqueue_script( 'evita-icon-picker-js', EVITA_PARENT_URI .'/assets/fonticonpicker/jquery.fonticonpicker.min.js', array( 'jquery', 'jquery-ui-sortable' ) );
	}
  ...
  public function render_content() {
    if ( ! empty( $this->icons ) ) { ?>
      <label>
        ...
        <select <?php $this->link(); ?> style="font-family: 'FontAwesome';" class="contact-icon-picker iconPicker">
          <?php
