...
/**
 * Evita
 * Customizer Control: Evita Radio Image control
 */

class Evita_Customize_Control_Radio_Image extends Evita_Customize_Base_Control {
	/**
	...
	public function render_content() {
		...
		<div id="<?php echo esc_attr( "input_{$this->id}" ); ?>" class="evita-radio-image-select">
