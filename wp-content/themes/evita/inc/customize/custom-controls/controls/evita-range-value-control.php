 ...
 * @access public
 */
class Evita_Customizer_Range_Control extends WP_Customize_Control {
	...
	/**
	 * Evita_Customizer_Range_Control constructor.
	 *
 ...
 */
function evita_sanitize_range_value( $input ) {
	if ( evita_is_json( $input ) ) {
