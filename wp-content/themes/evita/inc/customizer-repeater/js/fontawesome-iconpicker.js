(function ($) {
    ...
    wp.evitacustomizerRepeater = {
        ...
        init: function () {
            $('.iconpicker-items>i').on('click', function () {
                ...
                evita_customizer_repeater_refresh_social_icons(th);
                return false;
            });
        },
    ...
    $(document).ready(function () {
        wp.evitacustomizerRepeater.init();

        $('.iconpicker-search').on('keyup', function () {
            wp.evitacustomizerRepeater.search($(this));
        });

        $('.icp-auto').on('click', function () {
            wp.evitacustomizerRepeater.iconPickerToggle($(this));
        });
