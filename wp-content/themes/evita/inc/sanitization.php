 ...
 */
function evita_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function evita_sanitize_html( $html ) {
 ...
 */
function evita_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function evita_sanitize_range_value( $number, $setting ) {
 ...
 */
function evita_sanitize_select( $input, $setting ) {
 ...
 */
function evita_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function evita_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function evita_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}