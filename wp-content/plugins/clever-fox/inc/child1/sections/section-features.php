...
?>	
    ...
    <section class="feature-section features-home">
        <div class="bg-elements">
            <img src="<?php echo esc_url(get_template_directory_uri().'/assets/images/elements/element3.png'); ?>" alt="<?php	echo esc_attr__('Image','medazin-pro') ?>" class="element1">
            <img src="<?php echo esc_url(get_template_directory_uri().'/assets/images/elements/element8.png'); ?>" alt="<?php	echo esc_attr__('Image','medazin-pro') ?>" class="element2">
        </div>
        <div class="container">
