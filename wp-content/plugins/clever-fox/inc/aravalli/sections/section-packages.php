<?php  
	$pg_packages_ttl			= get_theme_mod('pg_packages_ttl',__('Explore','clever-fox')); 
	$pg_packages_sub		= get_theme_mod('pg_packages_sub',__('Aravalli Packages','clever-fox'));
	$pg_packages_desc		    = get_theme_mod('pg_packages_desc',__('Lorem Ipsum is simply dummy text of the printing and typesetting industryLorem Ipsum has been the industry\'s standard dummy text ever since the 1500s.of type and scrambled it to make a type specimen book.','clever-fox'));
