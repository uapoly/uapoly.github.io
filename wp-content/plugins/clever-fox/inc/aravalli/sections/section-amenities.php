...
$pg_about_amenities_ttl 	= get_theme_mod( 'pg_about_amenities_ttl',__('Hotel','clever-fox')); 
$pg_about_amenities_sub 	= get_theme_mod( 'pg_about_amenities_sub',__('Amenities','clever-fox')); 
$pg_about_amenities_desc 	= get_theme_mod( 'pg_about_amenities_desc',__('Lorem Ipsum is simply dummy text of the printing and typesetting industryLorem Ipsum has been the industry\'s standard dummy text ever since the 1500s.of type and scrambled it to make a type specimen book.','clever-fox')); 
