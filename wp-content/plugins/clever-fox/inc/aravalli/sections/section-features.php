...
if ( ! function_exists( 'cleverfox_aravalli_lite_features' ) ) :
	...
	$features_title 		= get_theme_mod('features_title',__('Explore','clever-fox'));
	$features_subtitle		= get_theme_mod('features_subtitle',__('theme Features','clever-fox')); 
	$features_description	= get_theme_mod('features_description',__('Lorem Ipsum is simply dummy text of the printing and typesetting industryLorem Ipsum has been the industry\'s standard dummy text ever since the 1500s.of type and scrambled it to make a type specimen book.','clever-fox'));
