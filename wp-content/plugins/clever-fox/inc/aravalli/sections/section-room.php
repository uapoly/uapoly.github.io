<?php  
	...
	$room_title			= get_theme_mod('room_title',__('Explore','clever-fox')); 
	$room_subtitle		= get_theme_mod('room_subtitle',__('Rooms & Suits','clever-fox'));
	$room_desc		    = get_theme_mod('room_desc',__('Lorem Ipsum is simply dummy text of the printing and typesetting industryLorem Ipsum has been the industry\'s standard dummy text ever since the 1500s.of type and scrambled it to make a type specimen book.','clever-fox'));
