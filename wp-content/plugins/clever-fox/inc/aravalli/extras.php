...
function cleverfox_aravalli_lite_checkin() {
	$checkin_title			= get_theme_mod('checkin_title',__('Find a Room','clever-fox')); 
	$checkin_desc			= get_theme_mod('checkin_desc',__('When you want to be our guest ?','clever-fox'));
