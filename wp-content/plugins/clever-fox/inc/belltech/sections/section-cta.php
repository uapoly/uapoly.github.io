...
if ( ! function_exists( 'belltech_lite_cta' ) ) :
	...
	$cta_title				= get_theme_mod('cta_title',__('Need Emergency <span>Plumbing Service?</span> Call us at','clever-fox'));
	$cta_description		= get_theme_mod('cta_description',__('24 hours, 7 days a week, 365 days a year','clever-fox'));
	$cta_btn_lbl1			= get_theme_mod('cta_btn_lbl1',__('Contact With Us','clever-fox'));
	$cta_btn_link1			= get_theme_mod('cta_btn_link1');
	$cta_btn_second_ttl		= get_theme_mod('cta_btn_second_ttl',__('or','clever-fox'));
	$cta_btn_lbl2			= get_theme_mod('cta_btn_lbl2',__('+1 (088) 456 888 (24/7)','clever-fox'));
