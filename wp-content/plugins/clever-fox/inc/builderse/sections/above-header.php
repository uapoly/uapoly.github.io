			...
			<div class="container">
				<div class="row align-items-center">
					<div class="col-lg-4 col-md-4 col-sm-12">
						<?php 
								$tlh_text_slider = get_theme_mod( 'tlh_text_slider',__('Welcome to Renoval Construction Company, Renoval Construction Company, Construction Company','clever-fox'));
					...
					<?php 
						...
						$tlh_office_timing 			= get_theme_mod( 'tlh_office_timing',__('Mon to Fri 9.00 A.m to 6.00 P.m','clever-fox'));
