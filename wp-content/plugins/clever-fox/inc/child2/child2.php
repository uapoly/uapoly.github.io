...
require CLEVERFOX_PLUGIN_DIR . 'inc/child2/features/medazin-features.php';
require CLEVERFOX_PLUGIN_DIR . 'inc/child2/features/medazin-team.php';
...
if ( ! function_exists( 'cleverfox_medazin_frontpage_sections' ) ) :
	function cleverfox_medazin_frontpage_sections() {	
		...
		require CLEVERFOX_PLUGIN_DIR . 'inc/child2/sections/section-features.php';
		require CLEVERFOX_PLUGIN_DIR . 'inc/medazin/sections/section-cta.php';
		require CLEVERFOX_PLUGIN_DIR . 'inc/child2/sections/section-team.php';
    }
