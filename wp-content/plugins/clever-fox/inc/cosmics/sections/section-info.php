<?php
	...
	function hantus_lite_info() {
		...
		$info_title				= get_theme_mod('info_title',__('Pedicure','clever-fox'));
		$info_description		= get_theme_mod('info_description',__('$49','clever-fox'));
		...
		$info_title2			= get_theme_mod('info_title2',__('Body Wraps','clever-fox'));
		$info_description2		= get_theme_mod('info_description2',__('$29','clever-fox'));
		...
		$info_title3			= get_theme_mod('info_title3',__('Menicures','clever-fox'));
		$info_description3		= get_theme_mod('info_description3',__('$79','clever-fox')); 
		...
		$info_title4			= get_theme_mod('info_title4',__('Facials','clever-fox'));
		$info_description4		= get_theme_mod('info_description4',__('$29','clever-fox')); 
		...
		$info_title5			= get_theme_mod('info_title5',__('Waxing','clever-fox'));
		$info_description5		= get_theme_mod('info_description5',__('$69','clever-fox')); 
