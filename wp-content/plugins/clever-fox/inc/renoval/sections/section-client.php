<?php  
	$client_subtitle		= get_theme_mod('client_subtitle',__('<h2>Outstanding</h2><div class="animation"><div class="first"><div>Sponsor</div></div></div>','clever-fox'));
	$client_description		= get_theme_mod('client_description',__('Lorem Ipsum is simply dummy of printing and typesetting and industry. Lorem Ipsum been.','clever-fox'));
