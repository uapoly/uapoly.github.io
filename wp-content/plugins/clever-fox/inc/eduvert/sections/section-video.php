...
$video_title 	  = get_theme_mod('video_title',__('Live classes','clever-fox'));
$video_description= get_theme_mod('video_description',__('high quality Live classes','clever-fox')); 
