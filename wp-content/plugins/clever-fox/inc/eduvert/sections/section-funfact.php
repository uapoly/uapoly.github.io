...
$funfact_title 		= get_theme_mod('funfact_title',__('Why Choose us','clever-fox'));
$funfact_subttl 	= get_theme_mod('funfact_subttl',__('we bring new developing idea & design','clever-fox'));
$funfact_description= get_theme_mod('funfact_description',__('There are many variations of passages of Lorem Ipsum available There are many variations of passages of Lorem Ipsum available are many variations of passages of Lorem Ipsum available There are many variations of passages of Lorem Ipsum available','clever-fox')); 
$funfact_btn_lbl	= get_theme_mod('funfact_btn_lbl',__('Choose Plan','clever-fox'));
