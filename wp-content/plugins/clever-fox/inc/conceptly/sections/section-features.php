...
if ( ! function_exists( 'conceptly_lite_features' ) ) :
	...
	$features_title				= get_theme_mod('features_title',__('Our Features','clever-fox'));
	$features_description		= get_theme_mod('features_description',__('There are many variations of passages of Lorem Ipsum available but the majority have suffered alteration in some form by injected humour.','clever-fox'));
...
<!-- Start: Our Features
    ...
    <section id="ourfeatures" class="section-padding home-feature position-relative">
			...
			<div class="row">
                <div class="col-lg-8 col-md-10 col-12">                    
					...
					<?php if ( ! empty( $features_title ) || is_customize_preview() ) : ?>
                        <h2><?php echo wp_kses_post($features_title); ?> <span></span></h2>
					<?php endif; ?>
        ...
        <div class="shape15"><img src="<?php echo esc_url( plugin_dir_url( __DIR__ ) . 'images/shape/shape15.png' ); ?>" alt="image"></div>
    </section>
	</section>
<?php } 
}
