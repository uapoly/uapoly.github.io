		...
		if ( 'Azwa' == $theme->name){
			...
			'conceptly_get_slides_default', json_encode(
			 array(
				...
				array('image_url' => CLEVERFOX_PLUGIN_URL .'inc/conceptly/images/sliders/slider01.jpg' ,'image_url2' => CLEVERFOX_PLUGIN_URL .'inc/azwa/images/sliders/slider01.png','link' => '#', 'title' => __('We Build Your','clever-fox'), 'subtitle' => __('Business IDEA','clever-fox'), 'text' => __('There are many variations of passages of Lorem Ipsum available but the majority have suffered injected humour dummy now.','clever-fox'), 'text2' => __('Read More','clever-fox'),'slide_align' => 'left', 'id' => 'customizer_repeater_00070' ), 
				
				/*Repeater's second item*/
				array('image_url' => CLEVERFOX_PLUGIN_URL .'inc/conceptly/images/sliders/slider02.jpg','image_url2' => CLEVERFOX_PLUGIN_URL .'inc/azwa/images/sliders/slider02.png','link' => '#', 'title' => __('We Build Your','clever-fox'), 'subtitle' => __('Business IDEA','clever-fox'), 'text' => __('There are many variations of passages of Lorem Ipsum available but the majority have suffered injected humour dummy now.','clever-fox'), 'text2' => __('Read More','clever-fox'),'slide_align' => 'center', 'id' => 'customizer_repeater_00071' ), 
				
				/*Repeater's third item*/
				array('image_url' => CLEVERFOX_PLUGIN_URL .'inc/conceptly/images/sliders/slider03.jpg','image_url2' => CLEVERFOX_PLUGIN_URL .'inc/azwa/images/sliders/slider03.png','link' => '#', 'title' => __('We Build Your','clever-fox'), 'subtitle' => __('Business IDEA','clever-fox'), 'text' => __('There are many variations of passages of Lorem Ipsum available but the majority have suffered injected humour dummy now.','clever-fox'), 'text2' => __('Read More','clever-fox'),'slide_align' => 'right', 'id' => 'customizer_repeater_00072' ), 
				)
			)
		);
	}else{
