            ...
            <div class="row text-lg-left text-md-center">
                <div class="col-lg-3 col-md-6 col-12 p-md-0 mt-md-0 mt-4">
                    <div class="featured-box wow fadeInUp first" data-wow-delay="0.1s">
                        <h5 class="title"><i class="fa <?php echo esc_attr( $info_icons ); ?>"></i> <?php echo wp_kses_post( $info_title ); ?></h5>
                ...
                <div class="col-lg-3 col-md-6 col-12 p-md-0 mt-md-0 mt-4">
                    <div class="featured-box wow fadeInUp second" data-wow-delay="0.1s">
                        <h5 class="title"><i class="fa <?php echo esc_attr( $info_icons2 ); ?>"></i> <?php echo wp_kses_post( $info_title2 ); ?></h5>
                ...
                <div class="col-lg-3 col-md-6 col-12 p-md-0 mt-md-0 mt-4">
                    <div class="featured-box wow fadeInUp third" data-wow-delay="0.1s">
                        <h5 class="title"><i class="fa <?php echo esc_attr( $info_icons3 ); ?>"></i> <?php echo wp_kses_post( $info_title3 ); ?></h5>
                ...
                <div class="col-lg-3 col-md-6 col-12 p-md-0 mt-md-0 mt-4">
                    <div class="featured-box wow fadeInUp fourth" data-wow-delay="0.1s">
                        <h5 class="title"><i class="fa <?php echo esc_attr( $info_contact_icon ); ?>"></i> <?php echo wp_kses_post( $info_contact_title ); ?></h5>
