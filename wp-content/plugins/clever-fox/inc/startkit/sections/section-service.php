				...
				<div class="features-eight wow fadeInUp" data-wow-delay="0.4s">
					<?php if(!empty($image)){?>
						<div class="features-image">
							<img class="image" src="<?php echo esc_url($image); ?>" <?php if ( ! empty( $title ) ) : ?> alt="<?php echo esc_attr( $title ); ?>" title="<?php echo esc_attr( $title ); ?>" <?php endif; ?> />
						</div>
					<?php } ?>
					<div class="features-contented">
						...
						<div class="featured-text">
							...
							<?php endif; ?>
							<?php //if ( ! empty( $link ) ) : ?>
							<a href="<?php echo esc_url( $link ); ?>" class="view-more">
