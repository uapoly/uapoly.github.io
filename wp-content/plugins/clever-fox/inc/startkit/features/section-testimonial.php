...
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	...
	$wp_customize->add_setting(
    	'testimonial_subttl',
    	array(
	        'default'			=> __('<span>Testimonial</span> <h6>Lorem is dummy text.</h6>','clever-fox'),
			'capability'     	=> 'edit_theme_options',
			'sanitize_callback' => 'startkit_sanitize_html',
			'transport'         => $selective_refresh,
			'priority' => 6,
		...
		class Startkit_testimonial__section_upgrade extends WP_Customize_Control {
			...
			?>
				...
				<?php }elseif( 'StartWeb' == $theme->name){ ?>
					<a class="customizer_testimonial_upgrade_section up-to-pro" href="https://www.nayrathemes.com/startweb-pro/" target="_blank" style="display: none;"><?php _e('Upgrade to Pro','clever-fox'); ?></a>
