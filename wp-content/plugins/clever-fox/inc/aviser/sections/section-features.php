...
if ( ! function_exists( 'avril_lite_features' ) ) :
	...
	$feature_title				= get_theme_mod('feature_title',__('Technology from tomorrow','clever-fox'));
	$feature_subtitle			= get_theme_mod('feature_subtitle',__('Outstanding <span class="av-heading animate-7"><span class="av-text-wrapper"><b class="is-show">Features</b>                                   <b>Features</b><b>Features</b></span></span>','clever-fox'));
	$feature_description		= get_theme_mod('feature_description',__('Lorem Ipsum is simply dummy of printing and typesetting and industry. Lorem Ipsum been.','clever-fox'));
