<?php
	...
	$hdr_time_title 			= get_theme_mod( 'hdr_time_title',__('Opening Hours - 10 Am to 6 PM','clever-fox'));
	$hs_hdr_welcome 			= get_theme_mod( 'hs_hdr_welcome','1');
	$hdr_welcome_icon 			= get_theme_mod( 'hdr_welcome_icon','fa-building-o');
	$hdr_welcome_ttl 			= get_theme_mod( 'hdr_welcome_ttl',__('Welcome to our Business Agency','clever-fox'));
?>
        <!--===// Start: Header Above
        =================================-->
