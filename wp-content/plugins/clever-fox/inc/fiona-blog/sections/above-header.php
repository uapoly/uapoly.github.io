<?php
	...
	$abv_hdr_first_trending_title 	= get_theme_mod( 'abv_hdr_first_trending_title',__('Trending','clever-fox')); 
	$abv_hdr_first_trending_desc 	= get_theme_mod( 'abv_hdr_first_trending_desc',__('Lorem ipsum dolor sit amet consectetur','clever-fox'));	
	$hs_abv_hdr_social 				= get_theme_mod('hs_abv_hdr_social','1');
	$abv_hdr_social_ttl 			= get_theme_mod('abv_hdr_social_ttl',__('IN SOCIAL','clever-fox'));
