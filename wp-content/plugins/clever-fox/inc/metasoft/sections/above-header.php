		...
		<div class="header-widget d-flex align-items-center">
			<div class="container">
				<div class="row">
					...
					$abv_hdr_lbl1 	= get_theme_mod( 'abv_hdr_lbl1',__('careers','clever-fox')); 
					$abv_hdr_url1 	= get_theme_mod( 'abv_hdr_url1'); 
					$abv_hdr_lbl2 	= get_theme_mod( 'abv_hdr_lbl2',__('help desk','clever-fox')); 
					$abv_hdr_url2 	= get_theme_mod( 'abv_hdr_url2'); 
					$abv_hdr_lbl3 	= get_theme_mod( 'abv_hdr_lbl3',__('login','clever-fox')); 
					...
					<div class="col-lg-6 col-12 mb-lg-0 mb-4">
						<div id="header-above-right" class="widget-right justify-content-lg-end justify-content-center text-lg-right text-center">
							<?php 
								...
								$tlh_contact_title 		 = get_theme_mod( 'tlh_contact_title',__('Mon to Fri 9:00am to 6:00pm','clever-fox')); 
							?>
							...
							<?php 
								...
								$tlh_email_title 		 = get_theme_mod( 'tlh_email_title',__('email@companyname.com','clever-fox'));
							?>	
