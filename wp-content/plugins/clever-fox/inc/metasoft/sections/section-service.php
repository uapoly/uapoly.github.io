...
if ( ! function_exists( 'metasoft_lite_service' ) ) :
	...
	$service_title  = get_theme_mod('service_title',__('Quality <span class="text-primary">Services</span>','clever-fox'));
	$service_description   = get_theme_mod('service_description',__('Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the standard dummy text.','clever-fox'));
