<?php  
	...
	$cta_call_title		= get_theme_mod('cta_call_title',__('Call Us:','clever-fox')); 
	$cta_call_text		= get_theme_mod('cta_call_text',__('<a href="#">+(01) 246 2365</a>','clever-fox'));
	$cta_right_icon		= get_theme_mod('cta_right_icon','fa-phone'); 
	$cta_title			= get_theme_mod('cta_title',__('Professional and Dedicated Consulting Services','clever-fox'));
	$cta_description	= get_theme_mod('cta_description',__('Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore.','clever-fox'));
	$cta_btn_icon		= get_theme_mod('cta_btn_icon','fa-arrow-right');
	$cta_btn_lbl		= get_theme_mod('cta_btn_lbl',__('Apply Now','clever-fox')); 	
