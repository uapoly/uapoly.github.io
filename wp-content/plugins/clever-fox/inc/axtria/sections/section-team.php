...
if ( ! function_exists( 'cleverfox_axtria_lite_team' ) ) :
	...
	$team_title					= get_theme_mod('team_title',__('Technology from tomorrow','clever-fox'));
	$team_subtitle				= get_theme_mod('team_subtitle',__('Outstanding <span class="av-heading animate-7"><span class="av-text-wrapper"><b class="is-show">Team</b>                                   <b>Team</b><b>Team</b></span></span>','clever-fox'));
	$team_description			= get_theme_mod('team_description',__('Lorem Ipsum is simply dummy of printing and typesetting and industry. Lorem Ipsum been.','clever-fox'));
