...
if ( ! function_exists( 'cleverfox_boostify_lite_testimonial' ) ) :
	...
	$testimonial_title			= get_theme_mod('testimonial_title',__('Outstanding <span class="av-heading animate-7"><span class="av-text-wrapper"><b class="is-show">Testimonial</b><b>Testimonial</b><b>Testimonial</b></span></span>','clever-fox'));
