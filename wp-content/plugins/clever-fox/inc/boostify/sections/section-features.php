...
if ( ! function_exists( 'cleverfox_boostify_lite_features' ) ) :
	...
	$feature_title			= get_theme_mod('feature_title',__('Outstanding <span class="av-heading animate-7"><span class="av-text-wrapper"><b class="is-show">Features</b>                                   <b>Features</b><b>Features</b></span></span>','clever-fox'));
