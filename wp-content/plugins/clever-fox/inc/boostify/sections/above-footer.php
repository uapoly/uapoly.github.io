<?php
	...
	function boostify_above_footer() {
		...
		$footer_above_ttl 			= get_theme_mod('footer_above_ttl',__('Do you like that you see?','clever-fox'));
		$footer_above_btn_lbl1 		= get_theme_mod('footer_above_btn_lbl1',__('Request a Quote','clever-fox'));
		$footer_above_btn_url1 		= get_theme_mod('footer_above_btn_url1','#');
		$footer_above_btn_mdl_text 	= get_theme_mod('footer_above_btn_mdl_text',__('or','clever-fox'));
		$footer_above_btn_lbl2 		= get_theme_mod('footer_above_btn_lbl2',__('Contact Us','clever-fox'));
