...
if ( ! function_exists( 'startbiz_contact_info' ) ) :
	...
	$hdr_nav_ct_info_ttl		= get_theme_mod('hdr_nav_ct_info_ttl',__('CALL FOR EMRGENCY','clever-fox'));
	$hdr_nav_ct_info_subttl		= get_theme_mod('hdr_nav_ct_info_subttl',__('+1-900-242-23-23','clever-fox'));
