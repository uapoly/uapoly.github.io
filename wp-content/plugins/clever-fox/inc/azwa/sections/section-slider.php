                ...
                <div class="container">
                    ...
                    <div class="theme-content text-<?php echo $align; ?>">
                    	<?php endif; ?>
							...
							<?php endif; ?>
							<?php if ( ! empty( $button ) ) : ?>
	                            <a href="<?php echo esc_url( $link ); ?>" <?php if($open_new_tab== 'yes' || $open_new_tab== '1') { echo "target='_blank'"; } ?> class="boxed-btn"><?php echo esc_html( $button ); ?><i class="fa fa-arrow-right"></i></a>
							<?php endif; ?>
