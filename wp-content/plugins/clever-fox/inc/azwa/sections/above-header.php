<?php
	...
	$header_email				= get_theme_mod('header_email',__('380 St Kilda Road','clever-fox'));
	$header_email_sub			= get_theme_mod('header_email_sub',__('email@companyname.com','clever-fox'));
	$header_phone_icon			= get_theme_mod('header_phone_icon','fa-phone'); 
	$header_phone_number		= get_theme_mod('header_phone_number',__('Call Us: (210) 123-451','clever-fox'));
	$header_phone_sub			= get_theme_mod('header_phone_sub',__('+1 231-214-3567','clever-fox'));
	...
	$header_faq_sub 			= get_theme_mod('header_faq_sub',__('On Azwa','clever-fox'));
	                    ...
	                    <ul class="header-info d-inline-block">
							<?php if($hide_show_contact_infot =='1'){ ?>
								<?php if($header_phone_sub) {?>
									<li class="tlh-phone">
										<a href="tel:<?php echo esc_attr($header_phone_sub); ?>">
							...
							<?php if($hide_show_email_infot =='1'){ ?>
								<?php if($header_email_sub) {?>
									<li class="tlh-email">
										<a href="mailto:<?php echo esc_attr($header_email_sub); ?>">
